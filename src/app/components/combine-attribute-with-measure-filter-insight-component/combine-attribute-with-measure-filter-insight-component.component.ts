...
@Component({
  selector: 'app-combine-attribute-with-measure-filter-insight-component',
  templateUrl: './combine-attribute-with-measure-filter-insight-component.component.html',
  styleUrls: ['./combine-attribute-with-measure-filter-insight-component.component.css']
})
export class CombineAttributeWithMeasureFilterInsightComponentComponent implements OnInit {
